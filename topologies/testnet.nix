{
  ...
  relayNodes = [
    ...
    }
    {
      ...
      org = "IOHK";
      nodeId = 10;
      producers = ["b-c-1" "e-c-2" "e-d-1" "e-a-1" "e-b-1"];
    }
    {
      name = "e-d-1";
      region = "us-east-2";
      org = "IOHK";
      nodeId = 11;
      producers = ["b-d-1" "e-d-2" "e-c-1" "e-a-1" "e-b-1"];
    }
    {
      name = "e-a-2";
      region = "eu-central-1";
    ...
    }
    {
      ...
      org = "IOHK";
      nodeId = 14;
      producers = ["b-c-1" "e-c-1" "e-a-2" "e-b-2" "e-d-2"];
    }
    {
      name = "e-d-2";
      region = "us-east-2";
      org = "IOHK";
      nodeId = 15;
      producers = ["b-d-1" "e-d-1" "e-a-2" "e-b-2" "e-c-2"];
    }
  ];
}
